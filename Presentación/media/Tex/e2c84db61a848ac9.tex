...
\begin{center}
Sea $(\mathscr{A},\mathscr{E})$ una categoría exacta. En caso de que $\text{Ext}^1(C,A)$ (obtenido siguiendo la construcción de Yoneda, como en categorías abelianas) sea un conjunto para cualesquiera
\end{center}
