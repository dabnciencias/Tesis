...
\begin{center}
definiendo a la realización $\mathfrak{s}(\delta)$ de $\delta=[A\xrightarrow{x} B\xrightarrow{y} C]$ como $\delta$ mismo se demuestra que $(\mathscr{A}, \text{Ext}^1, \mathfrak{s})$ es una categoría extriangulada.
\end{center}
